...
static void radio_event_handler(lv_event_t * e)
{
    ...
    LV_LOG_USER("User data pointer: %p", (void *)active_id);
    if (active_id == NULL) {
        LV_LOG_USER("Error: User data is NULL.");
        return;
    }
 ...
 */
void lv_checkboxes_as_radio_button_checkbox(void)
{
