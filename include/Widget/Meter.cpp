...
static lv_obj_t * meter;
static void set_value(void *indic, int32_t v) {
    lv_meter_indicator_t *indicator = (lv_meter_indicator_t *)indic;
    lv_meter_set_indicator_end_value(meter, indicator, v);
}

void lv_meter_with_multiple_arcs_meter(void)
{
    meter = lv_meter_create(lv_scr_act());
    lv_obj_center(meter);
    lv_obj_set_size(meter, 200, 200);
