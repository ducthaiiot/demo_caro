...
// void lv_variable_and_simple_img_1(void)
// {
...
// static void set_angle(void * img, int32_t v)
// {
//     lv_img_set_angle((lv_obj_t *)img, (int16_t)v);
// }

// static void set_zoom(void * img, int32_t v)
// {
//     lv_img_set_zoom( (lv_obj_t *)img, (int16_t)v);
// }

// /**
//  * Show transformations (zoom and rotation) using a pivot point.
//  */
// void lv_rotate_and_zoom_img(void)
// {
//     LV_IMG_DECLARE(img_cogwheel_argb);
 ...
 */
void lv_offset_and_styling_img(void)
{
