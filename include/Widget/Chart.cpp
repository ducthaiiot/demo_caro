...
//  */
// void lv_faded_area_line_chart_with_custom(void)
// {
//     /*Create a chart1*/
...
//  */
// void lv_axis_ticks_and_label_chart(void)
// {
//     /*Create a chart*/
//     lv_obj_t * chart;
//     chart = lv_chart_create(lv_scr_act());
...
//  */
// void lv_value_of_the_press_point_chart(void)
// {
//     /*Create a chart*/
//     lv_obj_t * chart;
//     chart = lv_chart_create(lv_scr_act());
...
//  */
// void lv_cursor_on_click_point_chart(void)
// {
//     chart = lv_chart_create(lv_scr_act());
//     lv_obj_set_size(chart, 200, 150);
...
//  * Stacked area chart
//  */
// void lv_stacked_area_chart(void)
// {
